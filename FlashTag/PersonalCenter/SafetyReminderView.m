...
@implementation SafetyReminderView
...
- (void)addSubviews
{
    ...
    [self.reminderButton setTitle:@"您的身份证后四位是？" forState:UIControlStateNormal];
    ...
    [self.reminderButton1 setTitle:@"您的出生地在哪？" forState:UIControlStateNormal];
    ...
    self.answerTextField.placeholder = @"答案";
